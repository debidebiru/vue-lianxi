...
<template>
    <div class="infoMenu">
        ...
        <el-table :data="tableData" border :rules="rules" style="width: 100%">
        ...
        <el-dialog :title="state ? '新增学生信息' : '修改学生信息'" :visible.sync="dialogFormVisible" width="500px">
            <el-form :model="form" :rules="rules" ref="form">
                ...
                <el-form-item label="母亲姓名" :label-width="formLabelWidth" prop="mather">
                    <el-input v-model="form.mather" aut-complete="off"></el-input>
                </el-form-item>
...
<script>
import { getData ,changeInfo,delData} from '../../../untils/table'
export default {
    data() {
        return {
            ...
            rules: {
                ...
                father: [{ required: true, message: '请输入父亲姓名' }],
                mather: [{ required: true, message: '请输入母亲姓名' }],
